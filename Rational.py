class Rational:
    ...
    def __mul__(self, secondRational):
        n = self.__numberator * secondRational[0]
        d = self.__denominator * secondRational[1]
        return Rational(n, d)
    ...
    def __str__(self):
        if self.__denominator == 1:
            ...
            return str(self.__numberator + "/" + self.__denominator)
